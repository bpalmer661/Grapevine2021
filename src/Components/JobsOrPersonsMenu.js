...
import { PersonsOrJobs } from '../redux/actions/dataActions'
...
export default function JobsOrPersonsMenu() {
...
localStorage.setItem("PersonsOrJobs",options[selectedIndex])
dispatch(PersonsOrJobs(distance));
