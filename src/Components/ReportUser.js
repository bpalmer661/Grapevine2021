...
const reportDetails = {
    userBeingReported: this.props.userBeingReported ?? "", 
    reportersUsername: this.props.reportersUsername ?? "",
...
axios.post(`https://australia-southeast1-workservices-e4506.cloudfunctions.net/api/reportUser`,reportDetails)
      }
...
componentDidMount(){
    ...
    console.log("componentDidMount called inside ReportUser : "  + this.props.jobId)
    ...
    console.log("this is userBeingReported : "  + this.props.userBeingReported)

    console.log("this is username : "  + this.props.username)

    console.log("this is reportersUsername  : "  + this.props.reportersUsername )
...
{ this.state.selectedImg && (
      ...
      <h5>Please Enter In Detail Why You Are Reporting This User</h5>
<TextField
fullWidth
maxwidth
 multiline
...
<MyButton onClick={this.handleOpen} tip="Report User" 
>
...
export default connect(mapStateToProps,mapActionsToProps)(withStyles(styles)(ReportUser));
